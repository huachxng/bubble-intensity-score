# =====================================================================
# BIS v1.0  —  05_backtest.R      *** REFERENCE SOLUTION ***
# =====================================================================
# Same file as R/05_backtest.R with the 3 TODOs filled in.
#
...
# =====================================================================
# Complete, no TODO. Run hand_check("2000-03") and follow along on a
# calculator. When you can reproduce R's number unaided, you own the index.
# ---------------------------------------------------------------------
